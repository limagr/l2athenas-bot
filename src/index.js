...
const { handleStreamerRequestButton, handleStreamerModalSubmit, handleStreamerApprove, handleStreamerReject, handleLinkCharacter } = require('./interactions/streamer')
...
client.on(Events.InteractionCreate, async (interaction) => {
  try {
    if (interaction.isChatInputCommand()) {
      ...
      if (interaction.commandName === 'vincular-personagem') return await handleLinkCharacter(interaction)
